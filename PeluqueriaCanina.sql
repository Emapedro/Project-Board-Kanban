...
insert into Historial(Fecha,Perro,Descripcion,Monto) values ('2021-02-16',2,'baño,corte,peinado',1500);
insert into Historial(Fecha,Perro,Descripcion,Monto) values ('2022-02-20',1,'baño,corte,peinado',1500);
insert into Historial(Fecha,Perro,Descripcion,Monto) values ('2021-03-08',5,'baño,peinado',1000);
